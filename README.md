...
You paste a GitHub repo URL. An AI destroys it. You feel things.

**Live at → [roast.oliverprojects.tech](https://roast.oliverprojects.tech)**

## Stack

- **Backend:** Node.js + Express
- **AI:** Claude Haiku (cheapest model. fitting.)
- **Frontend:** One HTML file. Don't @ me.
- **Hosting:** VPS + PM2 + Nginx + vibes

## Features

- 🔥 Brutally honest AI roast of any public GitHub repo
- 📊 Score out of 10 with a custom shame label
- 📸 Downloadable roast card image
- 🐦 One-click tweet your humiliation
- 🏆 Hall of Shame leaderboard (localStorage)
- 📋 README badge for the truly unhinged

## Self-Hosting

```bash
git clone https://github.com/Csiklaoliver/roast.git
cd roast
cp .env.example .env
...
MIT. Do whatever. The code has already suffered enough.

---

*Built by [Oliver](https://github.com/Csiklaoliver) · Powered by [Claude](https://anthropic.com) · Deployed on a VPS that has seen things*
